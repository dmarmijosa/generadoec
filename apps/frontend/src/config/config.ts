...
export const config = {
  ...
  apiUrl: getEnvVar('VITE_API_URL', isProduction ? '/api' : 'http://localhost:3000/api'),
  ...
  baseUrl: getEnvVar('BASE_URL', isProduction ? 'https://generadorec.dmarmijosa.com' : 'http://localhost:3000'),
  ...
  author: {
    ...
    linkedin: getEnvVar('AUTHOR_LINKEDIN', 'https://www.linkedin.com/in/dmarmijosa/'),
  ...
  app: {
    ...
    description: getEnvVar('APP_DESCRIPTION', 'Generador de datos ecuatorianos válidos para desarrollo y testing'),
  }
};
